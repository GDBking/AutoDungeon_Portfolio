...
public class SteamManager : MonoBehaviour
{
    ...
    public void ResetAllAchievementsAndStats()
    {
        ...
        SaveController.instance.saveDataAchi.totalAchiPoint = 0;
        SaveController.instance.saveDataAchi.achiPoint = 0;
        SaveController.instance.saveDataAchi.isCheck = new bool[10];
...
public static class SteamAchievement
{
    public static void Unlock(string achievementId)
    {
        ...
        if (SaveController.instance.saveDataAchi.achiPoint == 36) {
            Unlock("마침표");
        }
    }
}